...
const DeletedFilter = () => {
  return (
    <div class="w-full rounded-xl border border-gray-200 bg-white p-6 ">
      ...
      <div class="mt-8 grid grid-cols-1 gap-6 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-2">
      <div className="flex flex-col">
        ...
        <button class="active:scale-95 rounded-md bg-gray-200 px-6 py-2 font-medium text-black outline-none focus:ring-gray-500 hover:opacity-90 text-sm">
          Reset
        </button>
        <button
