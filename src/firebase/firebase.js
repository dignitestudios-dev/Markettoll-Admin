...
import { getFirestore, collection, doc, setDoc, addDoc,query,getDocs,onSnapshot } from "firebase/firestore";
...
export { app, db, collection, doc, setDoc, addDoc,query,getDocs,onSnapshot};
